...
LDFLAGS="-L`pwd`/net-snmp-lib/lib/ -O2 -g -fomit-frame-pointer   -Dlinux -D__linux__ -Dunix -D__uClinux__ -DEMBED -I${SNAPGEAR}/lib/uClibc/include -I${SNAPGEAR}/lib/libm -I${SNAPGEAR}/libcrypt_old -I${SNAPGEAR} -fno-builtin -nostartfiles -I${SNAPGEAR}/linux-2.4.x/include -Wl,-elf2flt  -L${SNAPGEAR}/lib/uClibc/lib -L${SNAPGEAR}/lib/libm -L${SNAPGEAR}/lib/libnet -L${SNAPGEAR}/lib/libdes -L${SNAPGEAR}/lib/libaes -L${SNAPGEAR}/lib/libpcap -L${SNAPGEAR}/lib/libcrypt_old -L${SNAPGEAR}/lib/libssl -L${SNAPGEAR}/lib/zlib -lpthread" \
